...
function MDM(inputElement) {
  ...
  this.activateControls = function(controlsElement) {
    var _self = this;
    $.each(["bold", "italic", "link", "title", "list"], function(idx, actionName) {
  ...
  this.activateInput = function(inputElement, controlsElement, previewElement) {
    ...
    $(inputElement).focus(function() {
      ...
      $(controlsElement).slideDown();
      $(previewElement).slideDown();
    });

    $(inputElement).blur(function() {
      if (!_self.click_on_control) {
        $(controlsElement).slideUp();
...
MDM.Utils = {
  ...
  controlsTemplate: function() {
    return "<div class=\"mdm-buttons mdm-control\">" +
      "  <ul>" +
  ...
  previewTemplate: function() {
    return "<div class=\"mdm-preview mdm-control\"></div>";
  }
};


$.fn.mdmagick = function() {
  this.each(function() {
    var mdm = new MDM(this);
  });
};
